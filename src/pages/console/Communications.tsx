...
const messages: Message[] = [
  {
    ...
    body: [
      '卢克：',
      '',
      '你需要看一下 α-7 测试端点的最新日志。那个外部地址又被访问了，',
      '这次访问源的特征码解析出了一部分——和中央枢纽网络没有任何关联。',
      '',
      '这不符合任何已知的通讯协议。我已经把日志转存了一份，',
      '内部系统最近不太稳定，我们用外部渠道保持联系。',
      '',
      '███',
    ],
  },
  {
    ...
    body: [
      '收到。',
      '',
      '我也注意到了。系统最近的异常日志比上个月多了三倍。',
      '我已经申请了对 α-7 端点的主动监控权限，但是审批被卡在中央枢纽。',
      '',
      '——陈主任的态度最近有点奇怪。',
      '',
      '继续用这个地址联系。别在公司内网留记录。',
  ...
  },
  {
    id: 'COM-0081',
    from: '███',
    to: '卢克 <bcma-ops@outlook.com>',
    subject: 'Re: 外部通讯端点异常',
    date: '2024/06/17',
    body: [
      '卢克：',
      '',
      '那个访问者又来了。这次他们下载了测试文件。',
      '',
      '——并且试图响应。',
      '',
      '这不是自动流量，卢克。另一边有人在操作。',
      '',
      '你需要亲自看一下。我把新的分析报告发到你外部邮箱了。',
      '',
      '还有一个问题: 他们的响应数据里包含的报头信息，',
      '和我们内部网络里一个已注销的节点特征码吻合。',
      '',
      '那个节点在三个月前就被标记为不存在了。',
      '',
      '███',
